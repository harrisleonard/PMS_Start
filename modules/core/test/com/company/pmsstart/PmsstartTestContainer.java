...
public class PmsstartTestContainer extends TestContainer {

    public PmsstartTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/pmsstart/app.properties",
    ...
    public static class Common extends PmsstartTestContainer {

        public static final PmsstartTestContainer.Common INSTANCE = new PmsstartTestContainer.Common();
